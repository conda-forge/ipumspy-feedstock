...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipumspy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15076&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipumspy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipumspy` can be installed with:

```
conda install ipumspy
```

It is possible to list all of the versions of `ipumspy` available on your platform with:
